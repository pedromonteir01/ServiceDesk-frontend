...
export const getRequestById = async (id) => {
  try {
    const response = await axios.get(`${api}/requests/${id}`, { cache: 'no-store' });
    if (response.data) {
...
export const getRequestByLocal = async (local) => {
  try {
    const response = await axios.get(`${api}/requests/local/${local}`, { cache: 'no-store' });
    if (response.data.length > 0) {
      return { requests: response.data };
    }
    return { error: 404, message: `Requests not found with this local: ${local}` };
  } catch (e) {
    console.log('Error fetching data:', e);
...
export const getRequestByStatus = async (status) => {
  try {
    const response = await axios.get(`${api}/requests/status/${status}`, { cache: 'no-store' });
    if (response.data.length > 0) {
      return { results: response.data.length, requests: response.data };
    }
    return { error: 404, message: `Requests not found with this status: ${status}` };
  } catch (e) {
    console.log('Error fetching data:', e);
...
export const getRequestByUser = async (user) => {
  try {
    const response = await axios.get(`${api}/requests/user/${user}`, { cache: 'no-store' });
    if (response.data.length > 0) {
      return { results: response.data.length, requests: response.data };
    }
    return { error: 404, message: `Requests not found with this user: ${user}` };
  } catch (e) {
    console.log('Error fetching data:', e);
...
export const createRequest = async (request) => {
  try {
    ...
    return { status: 'success', message: 'Request created', data: response.data };
  } catch (e) {
...
export const updateRequest = async (id, request) => {
  try {
    ...
    return { status: 'success', message: 'Request updated', data: response.data };
  } catch (e) {
...
export const deleteRequest = async (id) => {
  try {
    ...
    return { status: 'success', message: 'Request deleted', data: response.data };
  } catch (e) {
...
export const concludeStatus = async (id, status) => {
  try {
    const response = await axios.patch(`${api}/requests/${id}/conclude`, { status }, {
      headers: { 'Content-Type': 'application/json' },
    });
    return { status: 'success', message: 'Request concluded', data: response.data };
  } catch (e) {
